...
@include('common.css')
      ...
      <div class="container-fluid">
        <div class="row slider-row">
          ...
          <div class="col-lg-8 px-0">
            <div class="img-box">
                <svg viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto bg-gray-100 dark:bg-gray-900">
  ...
  <section class="about_section layout_padding">
    ...
    <div class="img-box">
      <div class="play_btn">
        <a href="#">
          <img src="{{asset('template/images/play.png')}}" alt="" />
        </a>
      </div>
      <img src="{{asset('template/images/about-img.png')}}" class="about-img" alt="" />
    </div>
  </section>
  <section class="gallery_section layout_padding-top">
    ...
    <div class="gallery_container">
      <div class="gallery_bg">
        <img src="{{asset('template/images/gallery-bg.png')}}" alt="" />
      </div>
      <div class="container">
        <div class="gallery_box">
          <div class="box b1">
            <div class="img-box">
              <img src="{{asset('template/images/gallery-1.jpg')}}" alt="" />
              <h5>
                photography
              </h5>
            </div>
          ...
          <div class="box b2">
            <div class="img-box">
              <img src="{{asset('template/images/gallery-2.jpg')}}" alt="" />
              <h5>
                photography
              </h5>
            </div>
            <div class="img-box">
              <img src="{{asset('template/images/gallery-3.')}}'" alt="" />
              <h5>
                photography
              </h5>
            </div>
          ...
          <div class="box b3">
            <div class="img-box">
              <img src="{{asset('template/images/gallery-4.jpg')}}" alt="" />
              <h5>
                photography
              </h5>
            </div>
            <div class="img-box">
              <img src="{{asset('template/images/gallery-5.jpg')}}" alt="" />
              <h5>
                photography
              </h5>
            </div>
          ...
          <div class="box b4">
            <div class="img-box">
              <img src="{{asset('template/images/gallery-6.jpg')}}" alt="" />
              <h5>
                photography
              </h5>
            </div>
        ...
        <div class="blog_box">
          <div class="row">
            <div class="col-md-6">
              <div class="box b1">
                <div class="img-box">
                  <img src="{{asset('template/images/blog1.jpg')}}" alt="" />
                </div>
            ...
            <div class="col-md-6">
              <div class="box b2">
                <div class="img-box">
                  <img src="{{asset('template/images/blog2.jpg')}}" alt="" />
                </div>
                <div class="blog-detail">
                  <div class="blog_title">
                    <h5>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <div class="client_content-box layout_padding">
                        <div class="img-box">
                          <img src="{{asset('template/images/client.png')}}" alt="" />
                        </div>
                        <div class="detail-box">
                          <h4>
                            Plio Dorak
                    ...
                    <div class="carousel-item">
                      <div class="client_content-box layout_padding">
                        ...
                        <div class="detail-box">
                          ...
                          <img src="{{asset('template/images/quote.png')}}" alt="" />
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item">
            ...
            <div class="col-lg-6">
              <div class="box b2">
                <div class="camera_img-box">
                  <img src="{{asset('template/images/camera.png')}}" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 ">
              <div class="social_box">
                <a href="#">
                  <img src="{{asset('template/images/facebook.png')}}" alt="" />
                </a>
                <a href="#">
                ...
                <a href="#">
                  <img src="{{asset('template/images/youtube.png')}}" alt="" />
                </a>
              </div>
            </div>
          </div>
            ...
            @endif
                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <a href="get_role_list/ALL/NA/ALL" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                <div class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-red-500">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Manage Role</h2>
